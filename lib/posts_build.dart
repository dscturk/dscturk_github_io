...
class PostsBuild {
  static const Map<String, _PostsBuild> posts = {
    r'''2020-02-05-using-flutter-to-generate-static-blog-with-markdown-for-github-pages.md''':
        const _PostsBuild(
      name:
          r'''using-flutter-to-generate-static-blog-with-markdown-for-github-pages''',
      frontmatter: r'''layout: post
...
''',
      ...
      title:
          r'''Using Flutter to Generate Static Blog with Markdown for GitHub Pages''',
      categories: const [r'''blog'''],
      author: const [r'''Mehmet Oguz Derin'''],
    ),
    r'''2020-01-01-dsc-turk.md''': const _PostsBuild(
      name: r'''dsc-turk''',
      frontmatter: r'''layout: post
title: DSC TURK
categories:
